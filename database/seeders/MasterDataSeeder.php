...
$inspectionPoints = [
    ...
    'Kelistrikan' => [
        ...
        ['name' => 'Kompresor AC', 'description' => 'Kondisi, kebocoran, dan fungsi kompresor AC', 'order' => 31],
        ['name' => 'Kondensor AC', 'description' => 'Kondisi dan kebersihan kondensor (depan radiator)', 'order' => 32],
        ['name' => 'Evaporator AC', 'description' => 'Kondisi evaporator dan housingnya di dalam kabin', 'order' => 33],
        ['name' => 'Receiver Drier / Accumulator', 'description' => 'Kondisi dan fungsi tabung dryer/accumulator', 'order' => 34],
        ['name' => 'Expansion Valve / Orifice Tube', 'description' => 'Fungsi katup ekspansi', 'order' => 35],
        ['name' => 'Selang & O-ring AC', 'description' => 'Pemeriksaan kebocoran pada selang dan sambungan AC', 'order' => 36],
        ['name' => 'Refrigerant (Freon)', 'description' => 'Tekanan dan jumlah refrigerant', 'order' => 37],
        ['name' => 'Blower Motor', 'description' => 'Kecepatan dan fungsi motor blower', 'order' => 38],
        ['name' => 'Panel Kontrol AC', 'description' => 'Fungsi semua tombol, mode, dan pengatur suhu', 'order' => 39],
        ['name' => 'Actuator Blend Door', 'description' => 'Fungsi actuator pengatur arah dan suhu udara', 'order' => 40],
        ['name' => 'Sensor Suhu Kabin', 'description' => 'Fungsi sensor suhu untuk AC otomatis', 'order' => 41],
    ],
